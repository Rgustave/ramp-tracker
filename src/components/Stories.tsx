  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-4 sm:p-6 lg:py-8">
      <div className="flex items-center justify-between">
        <div>
          <div className="text-[11px] font-bold uppercase tracking-[0.18em] text-amber-600">Behavioral bank</div>
          <h1 className="mt-1 text-3xl font-bold tracking-tight text-zinc-950 dark:text-white">Your stories</h1>
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">The stories that need practice rise to the top.</p>
        </div>
